    ...
    <section className=" relative  h-[100vh]  ">
      <div className="container-wrapper relative z-50 flex items-center flex-col ">
        <img
          src="images/free.png"
          alt=""
          className=" absolute left-0 sm:-left-[2%] h-[150px] sm:h-[220px] top-[2%] sm:top-[25%]"
        />
        <img
          src="images/winn.png"
          alt=""
        ...
        <div className="">
          <h1 className="uppercase archo-black text-xl sm:text-3xl txt-s text-white text-center tracking-tighter">
